export default function LocationMap() {
  return (
    <section id="map" className="bg-portfolio-purple-dark py-8">
        ...
        <div className="rounded-xl overflow-hidden">
          <div className="bg-gray-200 h-64 rounded-xl">
            <div className="w-full h-full flex items-center justify-center bg-portfolio-purple-medium/50 relative">
              ...
              <div className="absolute bottom-4 right-4 bg-portfolio-purple-dark/70 backdrop-blur-sm px-3 py-1.5 rounded-full text-sm">
