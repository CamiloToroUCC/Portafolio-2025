      ...
      items: [
        {
          ...
          description:
            "Lenguaje de marcado esencial para estructurar el contenido web.",
        },
        {
          name: "CSS",
          logo: "/placeholder-css.png",
          description:
            "Hojas de estilo que definen diseño visual y estética.",
        },
        {
          name: "JavaScript",
          logo: "/placeholder-js.png",
          description:
            "Lenguaje de scripting para dar interactividad en la web.",
        },
        {
          name: "React",
          logo: "/placeholder-react.png",
          description:
            "Biblioteca para construir interfaces de usuario de forma declarativa.",
        },
        {
          name: "TypeScript",
          logo: "/placeholder-ts.png",
          description:
            "Superset de JavaScript que añade tipado estático para mayor robustez.",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description:
            "Framework minimalista para Node.js y construcción de APIs.",
        },
        {
          name: "Python",
        ...
        },
        {
          ...
          description:
            "Framework de alto nivel para Python que impulsa un desarrollo rápido.",
        },
        {
          name: "PHP",
          logo: "/placeholder-php.png",
          description:
            "Lenguaje de scripting ampliamente usado en el desarrollo web.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description:
            "Base de datos NoSQL orientada a documentos y gran flexibilidad.",
        },
        {
          name: "MySQL",
          logo: "/placeholder-mysql.png",
          description:
            "Sistema de gestión de bases de datos relacional muy popular.",
        },
        {
          name: "PostgreSQL",
          logo: "/placeholder-postgresql.png",
          description:
            "Base de datos relacional avanzada con potentes características.",
        },
        {
          name: "Firebase",
          logo: "/placeholder-firebase.png",
          description:
            "Plataforma de Google que ofrece un backend listo para aplicaciones.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description:
            "Plataforma para desarrollar y ejecutar aplicaciones en contenedores.",
        },
        {
          name: "Git",
        ...
        },
        {
          ...
          description:
            "Automatización de procesos de integración y despliegue continuos.",
        },
        {
          name: "AWS",
          logo: "/placeholder-aws.png",
          description:
            "Plataforma en la nube con múltiples servicios para aplicaciones.",
        },
        {
          name: "Azure",
          logo: "/placeholder-azure.png",
          description:
            "Servicios en la nube de Microsoft para construir y desplegar aplicaciones.",
        },
      ],
    },
  ];
    ...
    <section id="skills" className="py-16 px-4">
      <div className="container mx-auto">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          {/* Contenedor de la diapositiva con ancho completo del contenedor */}
